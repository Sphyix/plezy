...
class _TranslationsDownloadsDe implements TranslationsDownloadsEn {
	...
	@override String pauseAllSkippedTranscoding({required Object count}) => '${count} transcodierende Elemente übersprungen — Transcoding-Downloads können nicht pausiert werden';
}
...
extension on TranslationsDe {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'downloads.pauseAllSkippedTranscoding' => ({required Object count}) => '${count} transcodierende Elemente übersprungen — Transcoding-Downloads können nicht pausiert werden',

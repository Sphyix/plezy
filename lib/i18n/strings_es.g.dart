...
class _TranslationsDownloadsEs implements TranslationsDownloadsEn {
	...
	@override String pauseAllSkippedTranscoding({required Object count}) => 'Se omitieron ${count} elementos en transcodificación — las descargas en transcodificación no se pueden pausar';
}
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'downloads.pauseAllSkippedTranscoding' => ({required Object count}) => 'Se omitieron ${count} elementos en transcodificación — las descargas en transcodificación no se pueden pausar',

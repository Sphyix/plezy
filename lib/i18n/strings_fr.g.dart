...
class _TranslationsDownloadsFr implements TranslationsDownloadsEn {
	...
	@override String pauseAllSkippedTranscoding({required Object count}) => '${count} éléments en transcodage ignorés — les téléchargements en transcodage ne peuvent pas être mis en pause';
}
...
extension on TranslationsFr {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'downloads.pauseAllSkippedTranscoding' => ({required Object count}) => '${count} éléments en transcodage ignorés — les téléchargements en transcodage ne peuvent pas être mis en pause',
